...
namespace PitStopBot.Commands {
    ...
    public class Giveaway : ModuleBase {
        ...
        [Summary("What the prize is for the winner.")] string prize,
        [Summary("Number of winners to be selected. Defaults to 1")] int numWinners = 1) {
            if (instanceDictionary.TryGetValue(Context.Channel.Id, out GiveawayInstance newInstance)) {
                ...
                await newInstance.RunGiveaway(seconds, prize, numWinners, Context, RemoveInstance);
            }
        }
